...
mheap.add("common cold", 5);
mheap.add("gunshot wound", 1);
mheap.add("high fever", 4);
mheap.add("broken arm", 2);
mheap.add("glass in foot", 3);
mheap.print();
mheap.remove("gunshot wound");
mheap.remove("broken arm");
mheap.remove("glass in foot");
mheap.print();
